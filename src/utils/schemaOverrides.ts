...
export const schemaOverrides: ModelOverrides = {
  ...
  'openai/gpt-5': {
    model: {
      ...
      default: 'gpt-5-nano',
      title: 'Model Variant',
      description: 'gpt-5: Most capable. gpt-5-mini: Balanced speed and cost. gpt-5-nano: Fastest and cheapest.',
      'x-order': 0,
    },
    prompt: {
      type: 'string',
    ...
    reasoning_effort: {
      ...
      description: 'How deeply the model thinks before responding',
      'x-order': 3,
    },
    verbosity: {
      type: 'string',
      ...
      default: 'medium',
      title: 'Verbosity',
      description: 'Control how much the model says',
      'x-order': 4,
    },
    temperature: {
      type: 'number',
